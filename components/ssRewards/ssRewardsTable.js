...
import { Button, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TableSortLabel, TablePagination, Typography, Skeleton, Accordion, AccordionSummary, AccordionDetails } from '@mui/material';
										...
										.map((row, index) => {
											...
											return (
												<TableRow key={'ssRewardsTable' + index} className={classes.assetTableRow}>
													...
													>
														{row && row.rewardType === 'Bribe' && row.gauge && row.gauge.balance && row.gauge.totalSupply && tableCellContent(formatCurrency(BigNumber(row.gauge.balance).div(row.gauge.totalSupply).times(row.gauge.reserve0)), formatCurrency(BigNumber(row.gauge.balance).div(row.gauge.totalSupply).times(row.gauge.reserve1)), row.token0.symbol, row.token1.symbol)}
														{row && row.rewardType === 'Fees' && row.balance && row.totalSupply && tableCellContent(formatCurrency(BigNumber(row.balance).div(row.totalSupply).times(row.reserve0)), formatCurrency(BigNumber(row.balance).div(row.totalSupply).times(row.reserve1)), row.token0.symbol, row.token1.symbol)}
														{row && row.rewardType === 'Reward' && row.gauge && row.gauge.balance && row.gauge.totalSupply && tableCellContent(formatCurrency(BigNumber(row.gauge.balance).div(row.gauge.totalSupply).times(row.gauge.reserve0)), formatCurrency(BigNumber(row.gauge.balance).div(row.gauge.totalSupply).times(row.gauge.reserve1)), row.token0.symbol, row.token1.symbol)}
														{row && row.rewardType === 'Distribution' && tableCellContent(formatCurrency(row.token?.lockValue), null, row.lockToken.symbol, null)}
													</TableCell>
														...
														>
															...
															{expanded !== labelId && (
																<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
																	<path
																		d="M25.5 13C25.5 6.1125 19.8875 0.5 13 0.499999C6.1125 0.499999 0.5 6.1125 0.499999 13C0.499999 19.8875 6.1125 25.5 13 25.5C19.8875 25.5 25.5 19.8875 25.5 13ZM12.3375 16.4875L7.925 12.075C7.7375 11.8875 7.65 11.65 7.65 11.4125C7.65 11.175 7.7375 10.9375 7.925 10.75C8.2875 10.3875 8.8875 10.3875 9.25 10.75L13 14.5L16.75 10.75C17.1125 10.3875 17.7125 10.3875 18.075 10.75C18.4375 11.1125 18.4375 11.7125 18.075 12.075L13.6625 16.4875C13.3 16.8625 12.7 16.8625 12.3375 16.4875Z"
																		fill="#779BF4"
																	/>
																</svg>
															)}
																...
																>
																	...
																	>
																		...
																		>
																			...
																			>
																				{headCell.id === 'balance' && row?.gauge && formatCurrency(BigNumber(row?.gauge?.balance).div(row?.gauge?.totalSupply).times(row?.gauge?.reserve0))}
																			</Typography>
																			...
																			>
																				{headCell.id === 'balance' && row?.gauge && formatCurrency(BigNumber(row.gauge.balance).div(row.gauge.totalSupply).times(row.gauge.reserve1))}
																			</Typography>
																		</div>
