...
// function getLibrary(_provider) {
//   const provider = stores.stableSwapStore.getStore('web3provider')
//   console.log('before provider', provider)
//   const library = new Web3Provider(provider);
//   console.log('after library', library)
//   // library.pollingInterval = 8000;
//   return library;
// }
